...
# Модуль преобразующий пути к локальным файлам
...
#Конверитует sample.html в pdf файл, на вход модуля подается словарь с параметрами для
# формирования invoice.pdf
def toPDF(**kwarg):
    ...
    # print(html)
    pisa.pisaDocument(html.encode("UTF-8"), result,
...
if __name__ == '__main__':
    ...
    input_json = {
        'invoice_number': '1',
        'contragent':  "ЗАО «УНИГРА», 121099, Москва, ул.Новый Арбат, 34, стр.1, помещение 1, этаж4, комнаты 7,8, ИНН 7704245553, КПП 771932001, р/с 40702810900000000195, банк ООО 'ДОЙЧЕ БАНК', г. Москва, кор.счет 30101810100000000101, БИК яяя",
        'price': '3750.12',
        'qty': '3',
